...
const services = [
  { title: "Terapia Manuale Empatica", description: "Un approccio pratico che si basa sulla connessione con il paziente per ristabilire l'equilibrio.", icon: <UserCircle className="w-8 h-8" /> },
  { title: "Riabilitazione Funzionale", description: "Esercizi mirati e costanti, imparando ad ascoltare veramente le risposte del tuo corpo.", icon: <Users className="w-8 h-8" /> },
  { title: "Supporto Concreto e Costante", description: "Ti seguo passo dopo passo nel percorso di guarigione, mettendoti sempre al centro.", icon: <Activity className="w-8 h-8" /> }
];
