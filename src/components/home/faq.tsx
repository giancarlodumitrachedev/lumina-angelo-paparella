...
const faqs = [
  { question: "Cosa intende per 'prima la persona, poi il paziente'?", answer: "Significa che non tratto solo il sintomo fisico in modo asettico. Mi piace creare un rapporto empatico, ascoltarti veramente per supportarti al 100%." },
  { question: "Devo portare abbigliamento specifico per le sedute?", answer: "Sì, consiglio abbigliamento intimo o sportivo molto comodo, per permettermi di valutare e trattare liberamente l'anatomia della zona interessata." }
];
